...
if mod == "blue":
	...
	write_cmd("AT+GMR")
	# get info
	# write_cmd("AT+UART_CUR?")
	# switch to station+AP mode
	write_cmd("AT+CWMODE=3")
	# set name
	write_cmd("AT+CWSAP_CUR=\"ESP8266-7\",\"1234567890\",5,3")
	# set ip address
	write_cmd("AT+CIPAP_CUR=\"192.168.7.1\",\"192.168.7.1\",\"255.255.255.0\"")
